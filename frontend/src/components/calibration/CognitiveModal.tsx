/**
 * ===============================================================================
 * SYNAPSE FRONTEND — Cognitive DNA Inspection Modal (CognitiveModal.tsx)
 * ===============================================================================
 * Purpose:
 *   • Modal dialog displaying the user's active Bayesian Cognitive Profile DNA,
 *     reasoning style, friction points, and confidence weights.
 *
 * Core Logic & Hierarchy:
 *   ├── Epistemic Footprint   : Abstractness, evidence threshold, reasoning style
 *   ├── Friction & Preferences: Anti-patterns, preferred presentation format
 *   └── Hypothesis Confidence : Bayesian confidence weights across domain topics
 * ===============================================================================
 */
...
export default function CognitiveModal() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* Glassmorphic Modal Dialog Shell */}
        <motion.div
          initial={{ opacity: 0, scale: 0.95, y: 20 }}
          animate={{ opacity: 1, scale: 1, y: 0 }}
          exit={{ opacity: 0, scale: 0.95, y: 20 }}
          transition={{ type: 'spring', stiffness: 300, damping: 25 }}
          className="w-full max-w-3xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] min-h-[520px] relative"
          style={{
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto chat-scroll p-7 md:p-8 pb-10 md:pb-12 bg-transparent">
            {/* Header */}
