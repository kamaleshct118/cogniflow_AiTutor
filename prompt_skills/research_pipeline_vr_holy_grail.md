...
> **Runtime Strategy:** Async Background Task | Gemini 3.1 Pro Native JSON Mode  
...
4. **Code & Math Sourcing:** If the topic involves programming or math, extract canonical code snippets or formulas.
